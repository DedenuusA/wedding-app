...
<body>
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light navbar-expand-xl" id="navBar">
                    <a href="#" class="navbar-brand">
                        <h4 class="text-primary display-6 fw-bold mb-0">{{ $wedding->bride_name }}<strong
                                class="text-secondary">&</strong>{{ $wedding->groom_name }}</h4>
                    </a>
                    ...
                    <div class="collapse navbar-collapse py-3" id="navbarCollapse">
                        ...
                        <div class="d-flex align-items-center flex-nowrap pt-xl-0">
                            <a href="#weddingRsvp" class="btn btn-primary btn-primary-outline-0 py-2 px-4 ms-4">Book
                                Attendance</a>
                        </div>
                    </div>
                </nav>
                ...
                @foreach ($gallery as $i => $img)
                    <div class="carousel-item {{ $i == 0 ? 'active' : '' }}">
                        ...
                        <img src="{{ asset('images/' . $img) }}" class="d-block w-100"
                            style="height: 100vh; object-fit: cover;" alt="Wedding Image">
                ...
                <div class="wedding-date-content">
                    <div class="d-inline-block border-end-0 border-start-0 border-secondary p-2 mb-4"
                        ...
                        <h4 class="text-dark text-uppercase fw-bold mb-0" style="letter-spacing: 3px;">
                            {{ \Carbon\Carbon::parse($wedding->date)->format('d F Y') }}</h4>
                    </div>
                    <h1 class="display-4">We Are Getting Married</h1>
                    <h5 class="text-uppercase text-dark fw-bold mb-4">{{ optional($wedding)->bride_name ?? '' }} <i
                            class="fa fa-heart text-primary"></i> {{ optional($wedding)->groom_name ?? '' }} </h5>
                    <p class="text-dark fs-5">Putri Dari {{ optional($wedding)->bride_parent ?? '' }} & Putra Dari
                        {{ optional($wedding)->groom_parent ?? '' }} </p>
                    ...
                    <a class="btn btn-primary btn-primary-outline-0 py-3 px-5" href="#weddingRsvp">Book Your
                        Attendance</a>
                </div>
    ...
    <div class="container-fluid wedding-timeline bg-secondary position-relative overflow-hidden py-5"
        ...
        <div class="position-absolute"
            style="top: 50%; right: -160px; transform: translateY(-50%) rotate(335deg); opacity: 0.5;">
            <img src="{{ asset('mr&mrs/img/wedding-bg.png') }}" class="img-fluid" alt="">
        </div>
                ...
                @if (optional($wedding)->kolom1)
                    <div class="col-lg-5 text-center wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div class="bg-white p-4 rounded shadow">
                            ...
                            <img src="{{ asset('images/' . $wedding->kolom1) }}" class="img-fluid mb-3"
        ...
        @if (!empty($gallery))
            ...
            <div class="container position-relative py-5">
                ...
                <div class="row g-4">
                    ...
                    @foreach ($gallery as $i => $img)
                        <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.{{ $i + 2 }}s">

                            <div class="gallery-item">

                                <div class="gallery-img">
                                    <img class="img-fluid w-100" src="{{ asset('images/' . $img) }}"
                                        alt="Wedding Photo">

                                    <div class="hover-style"></div>

                                    <div class="search-icon">
                                        <a href="{{ asset('images/' . $img) }}" data-lightbox="wedding-gallery"
                                            class="my-auto">
    ...
    <div class="container-fluid RSVP-form py-5" id="weddingRsvp">
                ...
                <div class="col-md-10">
                    <div class="p-5 border-secondary position-relative" style="border-style: double;">
                        <div class="fw-bold text-primary bg-white d-flex align-items-center justify-content-center position-absolute border-secondary p-2 wow fadeIn"
                            ...
                            Kindly respond by {{ \Carbon\Carbon::parse($wedding->date)->format('d F Y') }} we look
                            ...
                            <div class="row gx-4 gy-3">
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control py-3 border-0 bg-white text-dark"
                                            id="Examplename" placeholder="Input Name" name="name" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        <label for="Examplename" class="form-label text-dark">Number Of Guests</label>
                                        <input type="number" class="form-control py-3 border-0 bg-white text-dark"
                                            id="Examplename" placeholder="Number Of Guests" name="total_guest"
                                            required>
                                    </div>
                                </div>
                                <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        <label for="exampleselect" class="form-label text-dark">Confirmation of
                                            Attendance</label>
                                        <select class="form-control bg-white text-dark py-3 border-0"
                                            name="attendance" id="exampleselect">
                                ...
                                <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="form-group">
                                        ...
                                        <textarea name="message" class="form-control border-0 bg-white text-dark py-3 border-0" id="exampletextarea"
                                            cols="30" rows="5" placeholder="Input Message"></textarea>
                                    </div>
                                </div>
        ...
        <!-- Music button -->
        <button onclick="playMusic()" id="musicBtn" class="btn btn-primary btn-md-square"
        ...
        <!-- Template Javascript -->
        <scri src="{{ asset('mr&mrs/js/main.js') }}">
            </scri'pt>
            <script>
